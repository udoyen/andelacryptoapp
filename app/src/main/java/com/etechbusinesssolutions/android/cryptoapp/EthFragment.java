...
public class EthFragment extends Fragment implements LoaderManager.LoaderCallbacks<List<Currency>> {
    ...
    /**
     * URL for ETH crypto currency compared to 20 major international currencies
     */
    private static final String ETH_CRYPTO_CURRENCY_RATES_URL = "https://min-api.cryptocompare.com/data/price?fsym=ETH&tsyms=USD,EUR,NGN,RUB,CAD,JPY,GBP,AUD,INR,HKD,IDR,SGD,CHF,CNY,ZAR,THB,SAR,KRW,GHS,BRL";
